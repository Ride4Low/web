...
import { RouteFare, RequestRideProps, TripPreview, HTTPTripStartResponse } from "../type";
...
export default function RiderMap({ onRouteSelected }: RiderMapProps) {
    // Create icons inside component to avoid SSR issues
    ...
    const location = {
        latitude: 13.747857208858562,
        longitude: 100.50850314787347,
    };
